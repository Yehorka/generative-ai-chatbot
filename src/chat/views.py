...
class ChatViewSet(ModelViewSet):
    ...
    def send(self, request, pk=None):
        ...
        try:
            user_message, ai_message = get_ai_message(
                chat, message_text, image_file=image_file
            )
        ...
        user_payload = MessageSerializer(user_message).data
        assistant_payload = MessageSerializer(ai_message).data
        response_payload = {
            "user": user_payload,
...
class MessageCreateView(APIView):
    def post(self, request, chat_id):
        ...
        try:
            user_message, ai_message = get_ai_message(chat, message)
